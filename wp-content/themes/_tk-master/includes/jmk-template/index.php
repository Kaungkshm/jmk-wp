...
<main>
    ...
    <section class="home-about my-5 py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="images/index/home-about.png" alt="" class="w-100">
                </div>
                    ...
                    <div class="pt-4">
                        <a href="about-us.php" class="btn btn-all">
                            <div class="d-flex">
                                ...
                                <div class="ms-2">
                                    <img src="images/icon/down-right.png" alt="">
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="service-hover">
                                <img src="images/index/home-about-1.png" alt="" class="w-100">
                        ...
                        <div class="col-md-6">
                            <div class="service-hover">
                                <img src="images/index/home-about-2.png" alt="" class="w-100">
                                <div class="ms-5 service-overlay">
                                    <div>
                ...
                <div class="row g-4" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <div class="col-md-4">
                        <div class="gallery-hover">
                            <img src="images/index/home-gallery-1.png" alt="" class="w-100 gallery-img">
                    ...
                    <div class="col-md-4">
                        <div class="gallery-hover">
                            <img src="images/index/home-gallery-2.png" alt="" class="w-100 gallery-img">
                            <div class="gallery-overlay">
                                <img src="images/icon/zoom.png" alt="" class="gallery-icon">
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="gallery-hover">
                            <img src="images/index/home-gallery-3.png" alt="" class="w-100 gallery-img">
                            <div class="gallery-overlay">
                                <img src="images/icon/zoom.png" alt="" class="gallery-icon">
                            </div>
                        </div>
