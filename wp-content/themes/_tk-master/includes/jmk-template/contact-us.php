                ...
                <div class="col-md-6">
                    ...
                    <div class="address">
                        ...
                        <div class="contact-text my-4">
                            ...
                            <div class="d-flex my-2">
                                <div>
                                    <img src="images/icon/tele-blue.png" alt="">
                                </div>
                                <div class="ms-3">
                                    <p>+959776839875</p>
                                </div>
                            ...
                            <div class="d-flex my-2">
                                <div>
                                    <img src="images/icon/mail-blue.png" alt="">
                                </div>
                                <div class="ms-3">
                        ...
                        <div class="d-flex mt-4">
                            <div class="mx-2">
                                <a href="https://www.facebook.com/profile.php?id=100094866817867" target="_blank">
                                    <img src="images/icon/facebook.png" alt="" class="w-100">
                                </a>
                            </div>
                            <div class="mx-2">
                                <a href="">
                                    <img src="images/icon/youtube.png" alt="" class="w-100">
                                </a>
                            </div>
                            <div class="mx-2">
                                <a href="">
                                    <img src="images/icon/linkedin.png" alt="" class="w-100">
                                </a>
                            </div>
                            <div class="mx-2">
                                <a href="">
                                    <img src="images/icon/instragram.png" alt="" class="w-100">
                                </a>
                            </div>
                        </div>
                    </div>
