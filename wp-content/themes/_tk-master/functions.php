...
function _tk_scripts()
{
	...
	wp_enqueue_style('_tk-bootstrap', THEME_DIR_URI . '/includes/jmk-template/css/bootstrap.min.css');
	wp_enqueue_style('_tk-css', THEME_DIR_URI . '/includes/jmk-template/css/style.css');
	wp_enqueue_style('_tk-owl', THEME_DIR_URI . '/includes/jmk-template/css/owl.carousel.min.css');
